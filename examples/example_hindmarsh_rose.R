...
p0 <- c(15, 16, 45, 5, 6, 55, 0.3, 0.5, 0.6, 0.1)
u0 <- c(-1.31, -7.6, -0.2)
t_span <- c(0, 10)


modelODE <- function(tvec, state, parameters) {
  list(as.vector(hindmarsh_rose(state, parameters, tvec)))
}
...
p <- WendySolver(hindmarsh_rose, U, p0, tt, noise_sd)
